        ...
        <header class="main-header">
            ...
            <nav class="main-navigation">
                <ul class="nav-list">
                    ...
                    <li class="nav-list__item"><a href="{{route('user.basket')}}" class="nav-list__item__link">Мои заказы</a></li>
            ...
            <div class="header-container">
                <div class="payment-container">
                    <div class="payment-basket__status">
                        <div class="payment-basket__status__icon-block"><a href="{{route('basket.list')}}" class="payment-basket__status__icon-block__link"><i class="fa fa-shopping-basket"></i></a></div>
                    ...
                    <div class="content-head__container">
                        ...
                        <div class="content-head__search-block">
                            <div class="search-container">
                                <form class="search-container__form" action="{{route('search')}}" method="post" >
                                    @csrf
                ...
                <div class="random-product-container">
                    ...
                    <div class="random-product-container__content">
                        <div class="item-product">
                            @if ($randomProduct)
                            <div class="item-product__title-product"><a href="{{route('single.view', ['product' => $randomProduct])}}" class="item-product__title-product__link">{{$randomProduct->name}}</a></div>
                            <div class="item-product__thumbnail"><a href="{{route('single.view', ['product' => $randomProduct])}}" class="item-product__thumbnail__link"><img src="{{$randomProduct->image}}" alt="Preview-image" class="item-product__thumbnail__link__img"></a></div>
