...
<head>
    ...
    <title>single - ГеймсМаркет</title>
            ...
            <div class="content-middle">
                <div class="content-head__container">
                    <div class="content-head__title-wrap">
                        <div class="content-head__title-wrap__title bcg-title">{{$product->name}} в разделе {{$categoryName}}</div>
                    </div>
                ...
                <div class="content-main__container">
                    <div class="products-columns">
                        ...
                        <div class="products-columns__item">
                            <div class="products-columns__item__title-product"><a href="/single/?id={{$item->id}}" class="products-columns__item__title-product__link">{{$item->name}}</a></div>
                            <div class="products-columns__item__thumbnail"><a href="/single/?id={{$item->id}}" class="products-columns__item__thumbnail__link"><img src="{{$item->image}}" alt="Preview-image" class="products-columns__item__thumbnail__img"></a></div>
